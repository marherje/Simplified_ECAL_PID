...
do
    ...
    cp Performace_plots_template_3_cat_luxe.C $dir/Performance_plots.C
    ...
    sed -i "s/XweightAX/"$weightA"/g" Performance_plots.C
    sed -i "s/XweightBX/"$weightB"/g" Performance_plots.C
    sed -i "s/XweightCX/"$weightC"/g" Performance_plots.C
    sed -i "s/XtotaleventsX/"$totalevents"/g" Performance_plots.C
